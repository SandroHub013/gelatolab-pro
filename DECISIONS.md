...
| Interprete: parser prima del modello | Parser deterministico come percorso normale, modello linguistico come ripiego opzionale | Non è un'ottimizzazione ma la condizione economica del prodotto in abbonamento: a cache fredda un utente pesante costa 108 €/mese su Opus e 3,24 € con il parser davanti |
...
| Timeout sul riconoscimento vocale | Sessione chiusa a forza dopo 15 secondi | Azure fattura l'audio a tempo e il riconoscimento continuo non si ferma da solo: un microfono lasciato aperto per distrazione — in laboratorio, con le mani occupate, è lo scenario normale — costa finché qualcuno non se ne accorge |
